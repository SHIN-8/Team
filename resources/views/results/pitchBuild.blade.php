      ...
      <input type="hidden" name="pitch_games"" class="form-control" id="text4b" value="{{$result->game}}">
        ...
        <tr>          
          ...
          <div class="form-group">
              <input name="earned_run" class="form-control form-control-sm score" type="tel" id="text6c" value="0">
          </div>
          </td>
          <td>
          <div class="form-group">
              <input name="runs_allowed" class="form-control form-control-sm score" type="tel" id="text6c" value="0">
          </div>
          </td>
          <td>
          <div class="form-group">
              <input name="k" class="form-control form-control-sm score" type="tel" id="text6c" value="0">
          </div>
          </td>
          <td>
          <div class="form-group">
              <input name="give_four_dead_balls" class="form-control form-control-sm score" type="tel" id="text6c" value="0">
          </div>
          </td>          
          <td>
              <div class="form-group">
